...
/**
 * Modèle d'une séquence d'écoute issue d'une nuit de capture VigieChiro.
 *
 * <p>Une séquence représente un extrait audio de 5 secondes ralenti ×10 (cf. parcours utilisateur
 * P3 du brief SAE 2.01). Quatre attributs sont exposés sous forme de propriétés JavaFX afin que la
 * vue puisse s'y lier directement via les colonnes du TableView :
 *
 * <ul>
 *   <li>{@code horodatage} - heure d'enregistrement sur la nuit
 *   <li>{@code frequenceDominanteKHz} - fréquence ultrasonore principale détectée
 *   <li>{@code dureeSecondes} - durée de la séquence sur disque (typiquement 5 s ralenties ×10)
 *   <li>{@code statut} - "À écouter" tant que l'utilisateur n'a pas lancé la lecture, puis
 *       "Écoutée"
 * </ul>
 */
public class Sequence {
  ...
  public Sequence(LocalTime horodatage, double frequenceDominanteKHz, int dureeSecondes) {
